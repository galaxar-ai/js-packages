 ...
 */ function appendQuery(url, query) {
    ...
    var _url_split = _sliced_to_array(url.split("?", 2), 2), base = _url_split[0], qs = _url_split[1];
    var previousObj = (0, _urlQueryStringToObject.default)(qs);
    var newObj = typeof query === "string" ? (0, _urlQueryStringToObject.default)(query) : query;
    var newQs = (0, _urlObjectToQueryString.default)(_object_spread({}, previousObj, newObj));
