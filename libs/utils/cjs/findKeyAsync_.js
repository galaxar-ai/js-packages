...
function findKeyAsync_(obj, asyncPredicate_) {
    return _findKeyAsync_.apply(this, arguments);
}
function _findKeyAsync_() {
    _findKeyAsync_ = /**
 ...
 */ _async_to_generator(function(obj, asyncPredicate_) {
        var l, i, el, _tmp, _tmp1, _i, k, el1;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 10:
                    return [
                        2,
                        Promise.reject("The first argument should be a collection.")
                    ];
            }
        });
    });
